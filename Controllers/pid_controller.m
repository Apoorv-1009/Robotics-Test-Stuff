function pid_controller(x_des)
% Function that utilises a Proportional Integral Derivative controller for velocity control of a
...
plot(time, proportional, time, integral, 'g', time, derivative, 'r')
title('PID vs time')
grid on
